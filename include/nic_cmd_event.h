...
enum ENUM_SCN_FUNC_EXT_MASK {
	...
	ENUM_SCN_LIT_FORCE = (1 << 2),
	ENUM_SCN_LIT_FORCE_PRECISE = (1 << 3),
	ENUM_SCN_LIT_FROCE_BEST_EFFORT = (1 << 4),
	ENUM_SCN_RNR_SCAN = (1 << 13),
	ENUM_SCN_LLW_SCAN = (1 << 14),
	ENUM_SCN_SILENT_SCAN = (1 << 15)
};
