...
const struct wlan_dump_list mt6653_dump_list_wf_top_e = {
	...
	16, sizeof(mt6653_wf_top_e)/sizeof(struct wlan_dbg_command),
	mt6653_wf_top_e
};
...
const struct wlan_dump_list mt6653_dump_list_wf_bus_d = {
	...
	10, sizeof(mt6653_wf_bus_d)/sizeof(struct wlan_dbg_command),
	mt6653_wf_bus_d
};
...
const struct wlan_dump_list mt6653_dump_list_wf_bus_e = {
	...
	100, sizeof(mt6653_wf_bus_e)/sizeof(struct wlan_dbg_command),
	mt6653_wf_bus_e
};
...
const struct wlan_dump_list mt6653_dump_list_wf_mcu_hostcsr_a = {
	...
	35, sizeof(mt6653_wf_mcu_hostcsr_a)/sizeof(struct wlan_dbg_command),
...
const struct wlan_dump_list mt6653_dump_list_wf_mcu_hostcsr_b = {
	...
	35, sizeof(mt6653_wf_mcu_hostcsr_b)/sizeof(struct wlan_dbg_command),
...
const struct wlan_dump_list mt6653_dump_list_wf_mcu_hostcsr_c = {
	...
	32, sizeof(mt6653_wf_mcu_hostcsr_c)/sizeof(struct wlan_dbg_command),
...
const struct wlan_dump_list mt6653_dump_list_wf_mcu_hostcsr_d = {
	...
	16, sizeof(mt6653_wf_mcu_hostcsr_d)/sizeof(struct wlan_dbg_command),
