...
struct DMASHDL_CFG rMt7999DmashdlCfg = {
	.fgSlotArbiterEn = MT7999_DMASHDL_SLOT_ARBITER_EN,
	...
	.aucPriority2Group = {
		MT7999_DMASHDL_PRIORITY0_GROUP,
		MT7999_DMASHDL_PRIORITY1_GROUP,
		MT7999_DMASHDL_PRIORITY2_GROUP,
		MT7999_DMASHDL_PRIORITY3_GROUP,
		MT7999_DMASHDL_PRIORITY4_GROUP,
		MT7999_DMASHDL_PRIORITY5_GROUP,
		MT7999_DMASHDL_PRIORITY6_GROUP,
		MT7999_DMASHDL_PRIORITY7_GROUP,
		MT7999_DMASHDL_PRIORITY8_GROUP,
		MT7999_DMASHDL_PRIORITY9_GROUP,
		MT7999_DMASHDL_PRIORITY10_GROUP,
		MT7999_DMASHDL_PRIORITY11_GROUP,
		MT7999_DMASHDL_PRIORITY12_GROUP,
		MT7999_DMASHDL_PRIORITY13_GROUP,
		MT7999_DMASHDL_PRIORITY14_GROUP,
		MT7999_DMASHDL_PRIORITY15_GROUP,
	},

	.u2HifAckCntTh = MT7999_DMASHDL_HIF_ACK_CNT_TH,
	.u2HifGupActMap = MT7999_DMASHDL_HIF_GUP_ACT_MAP,
...
void mt7999DmashdlInit(struct ADAPTER *prAdapter)
{
	...
	asicConnac5xDmashdlSetPlePsePktMaxPage(
		prAdapter,
		rMt7999DmashdlCfg.u2PktPleMaxPage,
		rMt7999DmashdlCfg.u2PktPseMaxPage);

	for (idx = 0; idx < ENUM_DMASHDL_GROUP_NUM; idx++) {
		asicConnac5xDmashdlSetRefill(
			prAdapter, idx,
			rMt7999DmashdlCfg.afgRefillEn[idx]);
	...
	for (idx = 0; idx < 32; idx++)
		asicConnac5xDmashdlSetQueueMapping(
			prAdapter, idx,
			rMt7999DmashdlCfg.aucQueue2Group[idx]);

	for (idx = 0; idx < 16; idx++)
		asicConnac5xDmashdlSetUserDefinedPriority(
			prAdapter, idx,
			rMt7999DmashdlCfg.aucPriority2Group[idx]);
	...
	asicConnac5xDmashdlSetSlotArbiter(
		prAdapter,
		rMt7999DmashdlCfg.fgSlotArbiterEn,
		u4DefVal);
...
WF_HIF_DMASHDL_TOP_OPTIONAL_CONTROL_CR_PSEBF_BL_TH2_NOBMIN_RASIGN_ENA_MASK |
	...
	asicConnac5xDmashdlSetOptionalControl(prAdapter,
		rMt7999DmashdlCfg.u2HifAckCntTh,
		rMt7999DmashdlCfg.u2HifGupActMap,
		u4DefVal);
