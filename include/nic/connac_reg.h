 ...
 *******************************************************************************
 */
#define NIC_CONNAC_CFG_BASE		0x80020000

#define NIC_CONNAC_CFG_ON_BASE	0x81021000

#define CONN_CFG_ON_CONN_ON_MISC_ADDR	(NIC_CONNAC_CFG_ON_BASE + 0x140)
#define CONN_CFG_CHIP_ID_ADDR	        (NIC_CONNAC_CFG_BASE + 0x1010)
...
#define ERROR_DETECT_SER_BUS_HANG BIT(10)
