...
#endif
	DBGLOG(HAL, VOC, "[%s][H] [%s][Count: %d][MBUTO:%d]\n",
	...
	enum _ENUM_WFDMA_TYPE_T enum_wfdma_type)
{
	...
	DBGLOG(HAL, VOC, "WFDMA_HIF_BUSY(0x%08x): 0x%08x\n",
	       u4DmaCfgCr,
	       u4RegValue);

	u4DmaCfgCr = WF_WFDMA_EXT_WRAP_CSR_WFDMA_AXI_SLPPROT_CTRL_ADDR;
	HAL_RMCR_RD(HIF_DBG, prAdapter, u4DmaCfgCr, &u4RegValue);
	DBGLOG(HAL, VOC, "WFDMA_AXI_SLPPROT_CTRL(0x%08x): 0x%08x\n",
	       u4DmaCfgCr,
	       u4RegValue);

	u4DmaCfgCr = 0x20027078;
	HAL_RMCR_RD(HIF_DBG, prAdapter, u4DmaCfgCr, &u4RegValue);
	DBGLOG(HAL, VOC, "WFDMA_AXI_SLPPROT0_CTRL(0x%08x): 0x%08x\n",
	       u4DmaCfgCr,
	       u4RegValue);

	u4DmaCfgCr = 0x2002707C;
	HAL_RMCR_RD(HIF_DBG, prAdapter, u4DmaCfgCr, &u4RegValue);
	DBGLOG(HAL, VOC, "WFDMA_AXI_SLPPROT1_CTRL(0x%08x): 0x%08x\n",
	       u4DmaCfgCr,
	       u4RegValue);

	u4DmaCfgCr = WF_WFDMA_EXT_WRAP_CSR_WFDMA_MSI_CONFIG_ADDR;
	HAL_RMCR_RD(HIF_DBG, prAdapter, u4DmaCfgCr, &u4RegValue);
	DBGLOG(HAL, VOC, "WFDMA_MSI_CONFIG_ADDR(0x%08x): [0x%08x]",
...
void mt6653_dumpPcieReg(void)
{
	...
	DBGLOG(HAL, VOC, "Start dumpPcieReg.\n");
	...
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74030014, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x74030014] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74030018, &u4Value);
	...
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740310A8, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740310A8] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740310E0, &u4Value);
	...
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74031108, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x74031108] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74031110, &u4Value);
	...
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74070094, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x74070094] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74070098, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x74070098] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x7407009C, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x7407009C] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740700B0, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740700B0] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740700C0, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740700C0] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740700D0, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740700D0] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740700E0, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740700E0] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740700E4, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740700E4] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740730C0, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740730C0] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740730C4, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740730C4] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740730C8, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740730C8] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740730CC, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740700CC] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740700D0, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740700D0] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740750C0, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740750C0] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740750C4, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740750C4] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740750C8, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740750C8] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740750CC, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740750CC] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740750D0, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740750D0] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740750D4, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740750D4] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740750D8, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740750D8] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74076018, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x74076018] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74076098, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x74076098] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x7407609C, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x7407609C] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74079050, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x74079050] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74079054, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x74079054] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740790B0, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740790B0] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x740790B4, &u4Value);
	DBGLOG(HAL, VOC, "CR[0x740790B4] value[0x%08x]\n", u4Value);
}
...
static void mt6653_dumpConninfraBus(struct ADAPTER *ad, uint8_t fgIsDumpViaBt)
{
	...
	DBGLOG(HAL, VOC, "Start dump. fgIsDumpViaBt=%u\n", fgIsDumpViaBt);
	...
	u_int8_t fgIsDumpViaBt)
{
	...
	DBGLOG(HAL, VOC, "[PSOP_9_1] version=%s\n",
