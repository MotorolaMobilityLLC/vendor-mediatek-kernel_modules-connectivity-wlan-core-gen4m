...
#include "coda/mt7999/conn_gpio.h"
#include "coda/mt7999/conn_rf_spi_mst_reg.h"
#include "coda/mt7999/conn_rgu_on.h"
#include "coda/mt7999/conn_wt_slp_ctl_reg.h"
...
u_int8_t mt7999_pcie_show_mcu_debug_info(struct ADAPTER *ad,
	uint8_t *pucBuf, uint32_t u4Max, uint8_t ucFlag,
	uint32_t *pu4Length);
#elif defined(_HIF_USB)
u_int8_t mt7999_usb_show_mcu_debug_info(struct ADAPTER *ad,
	uint8_t *pucBuf, uint32_t u4Max, uint8_t ucFlag,
	uint32_t *pu4Length);
#endif
