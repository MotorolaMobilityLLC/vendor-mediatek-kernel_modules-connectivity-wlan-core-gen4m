...
//[File]            : wf_uwtbl_top.h
//[Revision time]   : Sun Jul  9 22:00:52 2023
...
#define WF_UWTBL_TOP_WTBL_DW_ADDR                              (WF_UWTBL_TOP_BASE + 0x1FF8) // 5FF8
...
/* =====================================================================================
  ...
  ---WIUCR (0x820c4000 + 0x0110)---
    ...
    PEERINFO_UPDATE[13]          - (W1) Update peer info according to the value of PICRn
...
/* =====================================================================================
  ...
  ---WTBL_DW (0x820c4000 + 0x1FF8)---

    WTBL_DW[31..0]               - (RO)  xxx 

 =====================================================================================*/
#define WF_UWTBL_TOP_WTBL_DW_WTBL_DW_ADDR                      WF_UWTBL_TOP_WTBL_DW_ADDR
#define WF_UWTBL_TOP_WTBL_DW_WTBL_DW_MASK                      0xFFFFFFFF                // WTBL_DW[31..0]
