...
enum ENUM_TXD_FIXED_RATE_INDEX {
	...
	FIXED_RATE_INDEX_OFDM_24M,
	FIXED_RATE_INDEX_HT_MCS0,
	FIXED_RATE_INDEX_VHT_MCS0,
	FIXED_RATE_INDEX_HE_MCS0,
	FIXED_RATE_INDEX_MLR_MCS0_SPE_IDX_FAVOR_WTBL, /* MLR for data packet*/
	FIXED_RATE_INDEX_CCK_1M_SPE_IDX_FAVOR_TXD,
	FIXED_RATE_INDEX_OFDM_6M_SPE_IDX_FAVOR_TXD,
	FIXED_RATE_INDEX_MLR_MCS0_SPE_IDX_FAVOR_TXD, /* MLR for Mgmt packet*/
};
