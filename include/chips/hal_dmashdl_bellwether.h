...
#define BELLWETHER_DMASHDL_QUEUE_3_TO_GROUP                (0x0)   /* LMAC AC03 */
...
#define BELLWETHER_DMASHDL_QUEUE_7_TO_GROUP                (0x1)   /* LMAC AC13 */
#define BELLWETHER_DMASHDL_QUEUE_8_TO_GROUP                (0x2)   /* LMAC AC20 */
#define BELLWETHER_DMASHDL_QUEUE_9_TO_GROUP                (0x2)   /* LMAC AC21 */
#define BELLWETHER_DMASHDL_QUEUE_10_TO_GROUP               (0x2)   /* LMAC AC22 */
#define BELLWETHER_DMASHDL_QUEUE_11_TO_GROUP               (0x2)   /* LMAC AC23 */
#define BELLWETHER_DMASHDL_QUEUE_12_TO_GROUP               (0x0)   /* LMAC AC30 */
#define BELLWETHER_DMASHDL_QUEUE_13_TO_GROUP               (0x0)   /* LMAC AC31 */
#define BELLWETHER_DMASHDL_QUEUE_14_TO_GROUP               (0x0)   /* LMAC AC32 */
#define BELLWETHER_DMASHDL_QUEUE_15_TO_GROUP               (0x0)   /* LMAC AC33 */
