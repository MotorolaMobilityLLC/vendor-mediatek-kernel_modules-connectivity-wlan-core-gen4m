...
WIFI_OPTS += CONFIG_MTK_WIFI_DRIVER_OWN_DELAY_SUPPORT=$(WIFI_DRIVER_OWN_DELAY_SUPPORT)
WIFI_OPTS += CONFIG_MTK_HOST_OFFLOAD_SUPPORT=$(WIFI_HOST_OFFLOAD_SUPPORT)
ifneq ($(CONFIG_WLAN_MT6985_MP2),)
    WIFI_OPTS += CONFIG_WLAN_MT6985_MP2=$(CONFIG_WLAN_MT6985_MP2)
endif
