...
#define CONNAC5X_TX_DESC_NON_802_11_MORE_DATA            BIT(16)
#define CONNAC5X_TX_DESC_NON_802_11_EOSP                 BIT(17)
...
#define CONNAC5X_TX_DESC_ENH_802_11_EOSP                 BIT(17)
...
#define CONNAC5X_TX_DESC_HW_AMSDU                        BIT(5)
...
#define CONNAC5X_TX_DESC_TX_STATUS_FORMAT                BIT(8)
#define CONNAC5X_TX_DESC_TX_STATUS_FORMAT_OFFSET         8
#define CONNAC5X_TX_DESC_TX_STATUS_TO_MCU                BIT(9)
#define CONNAC5X_TX_DESC_TX_STATUS_TO_HOST               BIT(10)
#define CONNAC5X_TX_DESC_OCCUPIED_BY_OTHER_LINK          BIT(11)
#define CONNAC5X_TX_DESC_FORCE_BSS_COLOR_TO_ZERO         BIT(12)
#define CONNAC5X_TX_DESC_BYPASS_RX_BASED_TX_BLOCKING     BIT(13)
#define CONNAC5X_TX_DESC_BYPASS_TX_BASED_TX_BLOCKING     BIT(14)
#define CONNAC5X_TX_DESC_FORCE_ASSIGN_LINK               BIT(15)
...
#define CONNAC5X_TX_DESC_AMSDU_CAP_UTXB                  BIT(1)
#define CONNAC5X_TX_DESC_DA_SOURCE_SELECTION             BIT(2)
#define CONNAC5X_TX_DESC_DIS_MAT                         BIT(3)
#define CONNAC5X_TX_DESC_RTS_DIS                         BIT(4)
#define CONNAC5X_TX_DESC_MSDU_COUNT_MASK                 BITS(10, 15)
#define CONNAC5X_TX_DESC_MSDU_COUNT_OFFSET               10
...
#define CONNAC5X_TX_DESC_FIXED_RATE_INDEX_MASK           BITS(16, 21)
#define CONNAC5X_TX_DESC_FIXED_RATE_INDEX_OFFSET         16
#define CONNAC5X_TX_DESC_BANDWIDTH_MASK                  BITS(22, 25)
#define CONNAC5X_TX_DESC_BANDWIDTH_OFFSET                22
#define CONNAC5X_TX_DESC_VALID_TXD_ARRIVAL_TIME          BIT(28)
#define CONNAC5X_TX_DESC_TX_PACKET_SOURCE_MASK           BITS(30, 31)
#define CONNAC5X_TX_DESC_TX_PACKET_SOURCE_OFFSET         30

/* DW 7 */
#define CONNAC5X_TX_DESC_SW_PREDICT_TX_TIME_MASK         BITS(0, 9)
#define CONNAC5X_TX_DESC_SW_PREDICT_TX_TIME_OFFSET       0
#define CONNAC5X_TX_DESC_ENABLE_ICI                      BIT(12)
#define CONNAC5X_TX_DESC_FORCE_RTS_CTS                   BIT(13)
#define CONNAC5X_TX_DESC_IMMEDIATE_TX                    BIT(14)

#define CONNAC5X_TX_DESC_UDP_TCP_CHECKSUM_OFFLOAD        BIT(15)
#define CONNAC5X_TX_DESC_AGGREGATED_TXD_COUNT_MASK       BITS(22, 25)
#define CONNAC5X_TX_DESC_AGGREGATED_TXD_COUNT_OFFSET     22
#define CONNAC5X_TX_DESC_THIS_TXD_IS_AGGREGATED          BIT(26)
#define CONNAC5X_TX_DESC_HIF_OR_MAC_TXD_SDO              BIT(27)
#define CONNAC5X_TX_DESC_DROP_BY_SDO                     BIT(28)
#define CONNAC5X_TX_DESC_IP_CHKSUM_OFFLOAD               BIT(29)
...
#define HAL_MAC_CONNAC5X_TXD_IS_MORE_DATA(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u4DW1 & CONNAC5X_TX_DESC_NON_802_11_MORE_DATA)?TRUE:FALSE)
#define HAL_MAC_CONNAC5X_TXD_SET_MORE_DATA(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW1 |= CONNAC5X_TX_DESC_NON_802_11_MORE_DATA)
#define HAL_MAC_CONNAC5X_TXD_UNSET_MORE_DATA(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW1 &= ~CONNAC5X_TX_DESC_NON_802_11_MORE_DATA)
...
#define HAL_MAC_CONNAC5X_TXD_IS_EOSP(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u4DW1 & CONNAC5X_TX_DESC_NON_802_11_EOSP)?TRUE:FALSE)
#define HAL_MAC_CONNAC5X_TXD_SET_EOSP(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW1 |= CONNAC5X_TX_DESC_NON_802_11_EOSP)
#define HAL_MAC_CONNAC5X_TXD_UNSET_EOSP(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW1 &= ~CONNAC5X_TX_DESC_NON_802_11_EOSP)
...
#define HAL_MAC_CONNAC5X_TXD_IS_FORCE_RTS_CTS_EN(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u4DW7 & CONNAC5X_TX_DESC_FORCE_RTS_CTS)?TRUE:FALSE)
#define HAL_MAC_CONNAC5X_TXD_SET_FORCE_RTS_CTS(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 |= CONNAC5X_TX_DESC_FORCE_RTS_CTS)
#define HAL_MAC_CONNAC5X_TXD_UNSET_FORCE_RTS_CTS(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 &= ~CONNAC5X_TX_DESC_FORCE_RTS_CTS)
...
(((_prHwMacTxDesc)->u4DW3 & CONNAC5X_TX_DESC_HW_AMSDU)?TRUE:FALSE)
#define HAL_MAC_CONNAC5X_TXD_SET_HW_AMSDU(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW3 |= CONNAC5X_TX_DESC_HW_AMSDU)
...
#define HAL_MAC_CONNAC5X_TXD_GET_TXS_FORMAT(_prHwMacTxDesc) \
TX_DESC_GET_FIELD((_prHwMacTxDesc)->u2DW5_0, \
CONNAC5X_TX_DESC_TX_STATUS_FORMAT, CONNAC5X_TX_DESC_TX_STATUS_FORMAT_OFFSET)

#define HAL_MAC_CONNAC5X_TXD_SET_TXS_FORMAT(_prHwMacTxDesc, _ucTXSFormat) \
TX_DESC_SET_FIELD(((_prHwMacTxDesc)->u2DW5_0), ((uint8_t)_ucTXSFormat), \
CONNAC5X_TX_DESC_TX_STATUS_FORMAT, CONNAC5X_TX_DESC_TX_STATUS_FORMAT_OFFSET)

#define HAL_MAC_CONNAC5X_TXD_IS_TXS_TO_MCU(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u2DW5_0 & CONNAC5X_TX_DESC_TX_STATUS_TO_MCU)?TRUE:FALSE)
#define HAL_MAC_CONNAC5X_TXD_SET_TXS_TO_MCU(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u2DW5_0 |= CONNAC5X_TX_DESC_TX_STATUS_TO_MCU)
#define HAL_MAC_CONNAC5X_TXD_UNSET_TXS_TO_MCU(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u2DW5_0 &= ~CONNAC5X_TX_DESC_TX_STATUS_TO_MCU)

#define HAL_MAC_CONNAC5X_TXD_IS_TXS_TO_HOST(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u2DW5_0 & CONNAC5X_TX_DESC_TX_STATUS_TO_HOST)?TRUE:FALSE)
#define HAL_MAC_CONNAC5X_TXD_SET_TXS_TO_HOST(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u2DW5_0 |= CONNAC5X_TX_DESC_TX_STATUS_TO_HOST)
...
(((_prHwMacTxDesc)->u2DW5_0 & CONNAC5X_TX_DESC_OCCUPIED_BY_OTHER_LINK) ? \
TRUE:FALSE)
...
(((_prHwMacTxDesc)->u2DW5_0 & CONNAC5X_TX_DESC_FORCE_BSS_COLOR_TO_ZERO) \
?TRUE:FALSE)
...
(((_prHwMacTxDesc)->u2DW5_0 & CONNAC5X_TX_DESC_BYPASS_RX_BASED_TX_BLOCKING) \
?TRUE:FALSE)
...
(((_prHwMacTxDesc)->u2DW5_0 & CONNAC5X_TX_DESC_BYPASS_TX_BASED_TX_BLOCKING) \
?TRUE:FALSE)
...
(((_prHwMacTxDesc)->u2DW5_0 & CONNAC5X_TX_DESC_FORCE_ASSIGN_LINK) ?TRUE:FALSE)
#define HAL_MAC_CONNAC5X_TXD_SET_FORCE_ASSIGN_LINK(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u2DW5_0 |= CONNAC5X_TX_DESC_FORCE_ASSIGN_LINK)
#define HAL_MAC_CONNAC5X_TXD_UNSET_FORCE_ASSIGN_LINK(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u2DW5_0 &= ~CONNAC5X_TX_DESC_FORCE_ASSIGN_LINK)

/* DW 6 */
#define HAL_MAC_CONNAC5X_TXD_IS_MLD(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u2DW6_0 & CONNAC5X_TX_DESC_MULTI_LINK_DEVICE)?TRUE:FALSE)
#define HAL_MAC_CONNAC5X_TXD_SET_MLD(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u2DW6_0 |= CONNAC5X_TX_DESC_MULTI_LINK_DEVICE)
...
#define HAL_MAC_CONNAC5X_TXD_IS_RTS_DIS(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u4DW6 & CONNAC5X_TX_DESC_RTS_DIS) ? TRUE:FALSE)
#define HAL_MAC_CONNAC5X_TXD_SET_RTS_DIS(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW6 |= CONNAC5X_TX_DESC_RTS_DIS)
#define HAL_MAC_CONNAC5X_TXD_UNSET_RTS_DIS(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW6 &= ~CONNAC5X_TX_DESC_RTS_DIS)
...
#define HAL_MAC_CONNAC5X_TXD_IS_VALID_TXD_ARRIVAL_TIME(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u4DW6 & CONNAC5X_TX_DESC_VALID_TXD_ARRIVAL_TIME)? \
TRUE:FALSE)
#define HAL_MAC_CONNAC5X_TXD_SET_VALID_TXD_ARRIVAL_TIME(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW6 |= CONNAC5X_TX_DESC_VALID_TXD_ARRIVAL_TIME)
#define HAL_MAC_CONNAC5X_TXD_UNSET_VALID_TXD_ARRIVAL_TIME(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW6 &= ~CONNAC5X_TX_DESC_VALID_TXD_ARRIVAL_TIME)
...
/* DW 7 */
#define HAL_MAC_CONNAC5X_TXD_GET_SW_PREDICT_TX_TIME(_prHwMacTxDesc) \
TX_DESC_GET_FIELD((_prHwMacTxDesc)->u4DW7, \
CONNAC5X_TX_DESC_SW_PREDICT_TX_TIME_MASK, \
CONNAC5X_TX_DESC_SW_PREDICT_TX_TIME_OFFSET)

#define HAL_MAC_CONNAC5X_TXD_SET_SW_PREDICT_TX_TIME( \
_prHwMacTxDesc, _ucTxTime) \
TX_DESC_SET_FIELD(((_prHwMacTxDesc)->u4DW7), ((uint8_t)_ucTxTime), \
CONNAC5X_TX_DESC_SW_PREDICT_TX_TIME_MASK, \
CONNAC5X_TX_DESC_SW_PREDICT_TX_TIME_OFFSET)

#define HAL_MAC_CONNAC5X_TXD_IS_ENABLE_ICI(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u4DW7 & CONNAC5X_TX_DESC_ENABLE_ICI) \
? FALSE : TRUE)
#define HAL_MAC_CONNAC5X_TXD_SET_ENABLE_ICI(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 |= CONNAC5X_TX_DESC_ENABLE_ICI)
#define HAL_MAC_CONNAC5X_TXD_UNSET_ENABLE_ICI(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 &= ~CONNAC5X_TX_DESC_ENABLE_ICI)
...
#define HAL_MAC_CONNAC5X_TXD_IS_TCP_UDP_CHKSUM_ENABLED(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u4DW7 & CONNAC5X_TX_DESC_UDP_TCP_CHECKSUM_OFFLOAD) \
? FALSE : TRUE)
#define HAL_MAC_CONNAC5X_TXD_SET_TCP_UDP_CHKSUM(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 |= CONNAC5X_TX_DESC_UDP_TCP_CHECKSUM_OFFLOAD)
#define HAL_MAC_CONNAC5X_TXD_UNSET_TCP_UDP_CHKSUM(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 &= ~CONNAC5X_TX_DESC_UDP_TCP_CHECKSUM_OFFLOAD)

#define HAL_MAC_CONNAC5X_TXD_GET_AGG_TXD_COUNT(_prHwMacTxDesc) \
TX_DESC_GET_FIELD((_prHwMacTxDesc)->u4DW7, \
CONNAC5X_TX_DESC_AGGREGATED_TXD_COUNT_MASK, \
CONNAC5X_TX_DESC_AGGREGATED_TXD_COUNT_OFFSET)

#define HAL_MAC_CONNAC5X_TXD_SET_AGG_TXD_COUNT(_prHwMacTxDesc, _ucAggTxdCnt) \
TX_DESC_SET_FIELD(((_prHwMacTxDesc)->u4DW7), ((uint8_t)_ucAggTxdCnt), \
CONNAC5X_TX_DESC_AGGREGATED_TXD_COUNT_MASK, \
CONNAC5X_TX_DESC_AGGREGATED_TXD_COUNT_OFFSET)

#define HAL_MAC_CONNAC5X_TXD_IS_TXD_AGGREGATED(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u4DW7 & CONNAC5X_TX_DESC_THIS_TXD_IS_AGGREGATED)?FALSE:TRUE)
#define HAL_MAC_CONNAC5X_TXD_SET_TXD_AGGREGATED(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 |= CONNAC5X_TX_DESC_THIS_TXD_IS_AGGREGATED)
#define HAL_MAC_CONNAC5X_TXD_UNSET_TXD_AGGREGATED(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 &= ~CONNAC5X_TX_DESC_THIS_TXD_IS_AGGREGATED)
...
(((_prHwMacTxDesc)->u4DW7 & CONNAC5X_TX_DESC_DROP_BY_SDO)?FALSE:TRUE)
#define HAL_MAC_CONNAC5X_TXD_SET_DROP_BY_SDO(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 |= CONNAC5X_TX_DESC_DROP_BY_SDO)
#define HAL_MAC_CONNAC5X_TXD_UNSET_DROP_BY_SDO(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 &= ~CONNAC5X_TX_DESC_DROP_BY_SDO)

#define HAL_MAC_CONNAC5X_TXD_IS_IP_CHKSUM_ENABLED(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u4DW7 & CONNAC5X_TX_DESC_IP_CHKSUM_OFFLOAD)?FALSE:TRUE)
#define HAL_MAC_CONNAC5X_TXD_SET_IP_CHKSUM(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 |= CONNAC5X_TX_DESC_IP_CHKSUM_OFFLOAD)
#define HAL_MAC_CONNAC5X_TXD_UNSET_IP_CHKSUM(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 &= ~CONNAC5X_TX_DESC_IP_CHKSUM_OFFLOAD)
