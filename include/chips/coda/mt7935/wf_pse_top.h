...
//[File]            : wf_pse_top.h
//[Revision time]   : Sun Jul  9 22:01:30 2023
...
#define WF_PSE_TOP_INT_N9_ERR2_MASK_ADDR                       (WF_PSE_TOP_BASE + 0x40) // 8040
#define WF_PSE_TOP_INT_N9_ERR3_MASK_ADDR                       (WF_PSE_TOP_BASE + 0x44) // 8044
...
#define WF_PSE_TOP_QUEUE_EMPTY_MASK_1_ADDR                     (WF_PSE_TOP_BASE + 0xC0) // 80C0
...
#define WF_PSE_TOP_PG_CPU1_GROUP_ADDR                          (WF_PSE_TOP_BASE + 0x148) // 8148
...
#define WF_PSE_TOP_CPU1_PG_INFO_ADDR                           (WF_PSE_TOP_BASE + 0x188) // 8188
...
#define WF_PSE_TOP_HIF_ENQ_PKT_NUM_1_ADDR                      (WF_PSE_TOP_BASE + 0x20C) // 820C
...
#define WF_PSE_TOP_SEC_ENQ_PKT_NUM_ADDR                        (WF_PSE_TOP_BASE + 0x220) // 8220
...
#define WF_PSE_TOP_GC_LOGIC_PART_RESET_MASK                    0x00000010                // LOGIC_PART_RESET[4]
#define WF_PSE_TOP_GC_LOGIC_PART_RESET_SHFT                    4
...
/* =====================================================================================
  ...
  ---PBUF_CTRL (0x820c8000 + 0x04)---
    ...
    TOTAL_PAGE_NUM[12..0]        - (RW) Total page numbers
                                     Set the total page before release PSE logic reset, and must not be changed after release logic reset.
    RESERVED13[16..13]           - (RO) Reserved bits
    PBUF_OFFSET[26..17]          - (RW) Packet buffer offset.
    ...
    PBUF_PTC_EN[28]              - (RW) Packet buffer protection
                                     After enable protection, WF_PSE.PBUF_CTRL/FREEPG_START_END/FREEPG_START_END_DTIM can not be updated.
    PBUF_PTC_SEL[29]             - (RW) Packet buffer protection range select
...
#define WF_PSE_TOP_PBUF_CTRL_PBUF_PTC_SEL_MASK                 0x20000000                // PBUF_PTC_SEL[29]
#define WF_PSE_TOP_PBUF_CTRL_PBUF_PTC_SEL_SHFT                 29
#define WF_PSE_TOP_PBUF_CTRL_PBUF_PTC_EN_ADDR                  WF_PSE_TOP_PBUF_CTRL_ADDR
#define WF_PSE_TOP_PBUF_CTRL_PBUF_PTC_EN_MASK                  0x10000000                // PBUF_PTC_EN[28]
#define WF_PSE_TOP_PBUF_CTRL_PBUF_PTC_EN_SHFT                  28
...
/* =====================================================================================
  ...
  ---INT_N9_EN_MASK (0x820c8000 + 0x08)---
    ...
    EN_HIF_Q13_NE[8]             - (RW) HIF queue 13 not empty interrupt
    EN_HIF_Q14_NE[9]             - (RW) HIF queue 14 not empty interrupt
    EN_HIF_Q15_NE[10]            - (RW) HIF queue 15 not empty interrupt
    EN_HIF_Q16_NE[11]            - (RW) HIF queue 16 not empty interrupt
...
/* =====================================================================================
  ...
  ---INT_N9_ERR_MASK (0x820c8000 + 0x24)---
    ...
    EN_DATA_OPER_EN_ERR_P7[31]   - (RW) Enable Data operation error of RLS port. Avoid unclear error flag,  please clear flag when logic reset.

 =====================================================================================*/
#define WF_PSE_TOP_INT_N9_ERR_MASK_EN_DATA_OPER_EN_ERR_P7_ADDR WF_PSE_TOP_INT_N9_ERR_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR_MASK_EN_DATA_OPER_EN_ERR_P7_MASK 0x80000000                // EN_DATA_OPER_EN_ERR_P7[31]
#define WF_PSE_TOP_INT_N9_ERR_MASK_EN_DATA_OPER_EN_ERR_P7_SHFT 31
...
/* =====================================================================================
  ...
  ---INT_N9_STS (0x820c8000 + 0x30)---
    ...
    RESERVED5[7..5]              - (RO) Reserved bits
    HIF_Q13_NE[8]                - (W1C) HIF queue 13 not empty interrupt status
    HIF_Q14_NE[9]                - (W1C) HIF queue 14 not empty interrupt status
    HIF_Q15_NE[10]               - (W1C) HIF queue 15 not empty interrupt status
    HIF_Q16_NE[11]               - (W1C) HIF queue 16 not empty interrupt status
...
/* =====================================================================================
  ...
  ---INT_N9_ERR_STS (0x820c8000 + 0x34)---
    ...
    DATA_OPER_ERR_P7[31]         - (W1C) Data operation error of RLS port. Avoid unclear error flag,  please clear flag when logic reset.

 =====================================================================================*/
#define WF_PSE_TOP_INT_N9_ERR_STS_DATA_OPER_ERR_P7_ADDR        WF_PSE_TOP_INT_N9_ERR_STS_ADDR
#define WF_PSE_TOP_INT_N9_ERR_STS_DATA_OPER_ERR_P7_MASK        0x80000000                // DATA_OPER_ERR_P7[31]
#define WF_PSE_TOP_INT_N9_ERR_STS_DATA_OPER_ERR_P7_SHFT        31
...
/* =====================================================================================
  ...
  ---INT_N9_ERR2_MASK (0x820c8000 + 0x40)---

    EN_DATA_OPER_ERR_TYPE_P0[4..0] - (RW) Enable Data operation error type of HIF port.
                                     Bit 0 : data operation error from read access 
                                     Bit 1 : data operation error from write access 
                                     Bit 2 : data operation error from invalid fid access
                                     Bit 3 : data operation error from invalid range read access 
                                     Bit 4 : data operation error from invalid range write access
    RSV0[7..5]                   - (RW) reserved
    EN_DATA_OPER_ERR_TYPE_P1[12..8] - (RW) Enable Data operation error type of CPU port.
                                     Bit 0 : data operation error from read access 
                                     Bit 1 : data operation error from write access 
                                     Bit 2 : data operation error from invalid fid access
                                     Bit 3 : data operation error from invalid range read access 
                                     Bit 4 : data operation error from invalid range write access
    RSV1[15..13]                 - (RW) reserved
    EN_DATA_OPER_ERR_TYPE_P2[20..16] - (RW) Enable Data operation error type of LMAC port.
                                     Bit 0 : data operation error from read access 
                                     Bit 1 : data operation error from write access 
                                     Bit 2 : data operation error from invalid fid access
                                     Bit 3 : data operation error from invalid range read access 
                                     Bit 4 : data operation error from invalid range write access
    RSV2[23..21]                 - (RW) reserved
    EN_DATA_OPER_ERR_TYPE_P3[28..24] - (RW) Enable Data operation error type of MDP port.
                                     Bit 0 : data operation error from read access 
                                     Bit 1 : data operation error from write access 
                                     Bit 2 : data operation error from invalid fid access
                                     Bit 3 : data operation error from invalid range read access 
                                     Bit 4 : data operation error from invalid range write access
    RSV3[31..29]                 - (RW) reserved

 =====================================================================================*/
#define WF_PSE_TOP_INT_N9_ERR2_MASK_RSV3_ADDR                  WF_PSE_TOP_INT_N9_ERR2_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR2_MASK_RSV3_MASK                  0xE0000000                // RSV3[31..29]
#define WF_PSE_TOP_INT_N9_ERR2_MASK_RSV3_SHFT                  29
#define WF_PSE_TOP_INT_N9_ERR2_MASK_EN_DATA_OPER_ERR_TYPE_P3_ADDR WF_PSE_TOP_INT_N9_ERR2_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR2_MASK_EN_DATA_OPER_ERR_TYPE_P3_MASK 0x1F000000                // EN_DATA_OPER_ERR_TYPE_P3[28..24]
#define WF_PSE_TOP_INT_N9_ERR2_MASK_EN_DATA_OPER_ERR_TYPE_P3_SHFT 24
#define WF_PSE_TOP_INT_N9_ERR2_MASK_RSV2_ADDR                  WF_PSE_TOP_INT_N9_ERR2_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR2_MASK_RSV2_MASK                  0x00E00000                // RSV2[23..21]
#define WF_PSE_TOP_INT_N9_ERR2_MASK_RSV2_SHFT                  21
#define WF_PSE_TOP_INT_N9_ERR2_MASK_EN_DATA_OPER_ERR_TYPE_P2_ADDR WF_PSE_TOP_INT_N9_ERR2_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR2_MASK_EN_DATA_OPER_ERR_TYPE_P2_MASK 0x001F0000                // EN_DATA_OPER_ERR_TYPE_P2[20..16]
#define WF_PSE_TOP_INT_N9_ERR2_MASK_EN_DATA_OPER_ERR_TYPE_P2_SHFT 16
#define WF_PSE_TOP_INT_N9_ERR2_MASK_RSV1_ADDR                  WF_PSE_TOP_INT_N9_ERR2_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR2_MASK_RSV1_MASK                  0x0000E000                // RSV1[15..13]
#define WF_PSE_TOP_INT_N9_ERR2_MASK_RSV1_SHFT                  13
#define WF_PSE_TOP_INT_N9_ERR2_MASK_EN_DATA_OPER_ERR_TYPE_P1_ADDR WF_PSE_TOP_INT_N9_ERR2_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR2_MASK_EN_DATA_OPER_ERR_TYPE_P1_MASK 0x00001F00                // EN_DATA_OPER_ERR_TYPE_P1[12..8]
#define WF_PSE_TOP_INT_N9_ERR2_MASK_EN_DATA_OPER_ERR_TYPE_P1_SHFT 8
#define WF_PSE_TOP_INT_N9_ERR2_MASK_RSV0_ADDR                  WF_PSE_TOP_INT_N9_ERR2_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR2_MASK_RSV0_MASK                  0x000000E0                // RSV0[7..5]
#define WF_PSE_TOP_INT_N9_ERR2_MASK_RSV0_SHFT                  5
#define WF_PSE_TOP_INT_N9_ERR2_MASK_EN_DATA_OPER_ERR_TYPE_P0_ADDR WF_PSE_TOP_INT_N9_ERR2_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR2_MASK_EN_DATA_OPER_ERR_TYPE_P0_MASK 0x0000001F                // EN_DATA_OPER_ERR_TYPE_P0[4..0]
#define WF_PSE_TOP_INT_N9_ERR2_MASK_EN_DATA_OPER_ERR_TYPE_P0_SHFT 0

/* =====================================================================================

  ---INT_N9_ERR3_MASK (0x820c8000 + 0x44)---

    EN_DATA_OPER_ERR_TYPE_P4[4..0] - (RW) Enable Data operation error type of SEC port.
                                     Bit 0 : data operation error from read access 
                                     Bit 1 : data operation error from write access 
                                     Bit 2 : data operation error from invalid fid access
                                     Bit 3 : data operation error from invalid range read access 
                                     Bit 4 : data operation error from invalid range write access
    RSV0[7..5]                   - (RW) reserved
    EN_DATA_OPER_ERR_TYPE_P5[12..8] - (RW) Enable Data operation error type of PLE port.
                                     Bit 0 : data operation error from read access 
                                     Bit 1 : data operation error from write access 
                                     Bit 2 : data operation error from invalid fid access
                                     Bit 3 : data operation error from invalid range read access 
                                     Bit 4 : data operation error from invalid range write access
    RSV1[15..13]                 - (RW) reserved
    EN_DATA_OPER_ERR_TYPE_P6[20..16] - (RW) Enable Data operation error type of AMSDU port.
                                     Bit 0 : data operation error from read access 
                                     Bit 1 : data operation error from write access 
                                     Bit 2 : data operation error from invalid fid access
                                     Bit 3 : data operation error from invalid range read access 
                                     Bit 4 : data operation error from invalid range write access
    RSV2[23..21]                 - (RW) reserved
    EN_DATA_OPER_ERR_TYPE_P7[28..24] - (RW) Enable Data operation error type of RLS port.
                                     Bit 0 : data operation error from read access 
                                     Bit 1 : data operation error from write access 
                                     Bit 2 : data operation error from invalid fid access
                                     Bit 3 : data operation error from invalid range read access 
...
#define WF_PSE_TOP_INT_N9_ERR3_MASK_RSV3_MASK                  0xE0000000                // RSV3[31..29]
#define WF_PSE_TOP_INT_N9_ERR3_MASK_RSV3_SHFT                  29
#define WF_PSE_TOP_INT_N9_ERR3_MASK_EN_DATA_OPER_ERR_TYPE_P7_ADDR WF_PSE_TOP_INT_N9_ERR3_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR3_MASK_EN_DATA_OPER_ERR_TYPE_P7_MASK 0x1F000000                // EN_DATA_OPER_ERR_TYPE_P7[28..24]
#define WF_PSE_TOP_INT_N9_ERR3_MASK_EN_DATA_OPER_ERR_TYPE_P7_SHFT 24
#define WF_PSE_TOP_INT_N9_ERR3_MASK_RSV2_ADDR                  WF_PSE_TOP_INT_N9_ERR3_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR3_MASK_RSV2_MASK                  0x00E00000                // RSV2[23..21]
#define WF_PSE_TOP_INT_N9_ERR3_MASK_RSV2_SHFT                  21
#define WF_PSE_TOP_INT_N9_ERR3_MASK_EN_DATA_OPER_ERR_TYPE_P6_ADDR WF_PSE_TOP_INT_N9_ERR3_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR3_MASK_EN_DATA_OPER_ERR_TYPE_P6_MASK 0x001F0000                // EN_DATA_OPER_ERR_TYPE_P6[20..16]
#define WF_PSE_TOP_INT_N9_ERR3_MASK_EN_DATA_OPER_ERR_TYPE_P6_SHFT 16
#define WF_PSE_TOP_INT_N9_ERR3_MASK_RSV1_ADDR                  WF_PSE_TOP_INT_N9_ERR3_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR3_MASK_RSV1_MASK                  0x0000E000                // RSV1[15..13]
#define WF_PSE_TOP_INT_N9_ERR3_MASK_RSV1_SHFT                  13
#define WF_PSE_TOP_INT_N9_ERR3_MASK_EN_DATA_OPER_ERR_TYPE_P5_ADDR WF_PSE_TOP_INT_N9_ERR3_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR3_MASK_EN_DATA_OPER_ERR_TYPE_P5_MASK 0x00001F00                // EN_DATA_OPER_ERR_TYPE_P5[12..8]
#define WF_PSE_TOP_INT_N9_ERR3_MASK_EN_DATA_OPER_ERR_TYPE_P5_SHFT 8
#define WF_PSE_TOP_INT_N9_ERR3_MASK_RSV0_ADDR                  WF_PSE_TOP_INT_N9_ERR3_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR3_MASK_RSV0_MASK                  0x000000E0                // RSV0[7..5]
#define WF_PSE_TOP_INT_N9_ERR3_MASK_RSV0_SHFT                  5
#define WF_PSE_TOP_INT_N9_ERR3_MASK_EN_DATA_OPER_ERR_TYPE_P4_ADDR WF_PSE_TOP_INT_N9_ERR3_MASK_ADDR
#define WF_PSE_TOP_INT_N9_ERR3_MASK_EN_DATA_OPER_ERR_TYPE_P4_MASK 0x0000001F                // EN_DATA_OPER_ERR_TYPE_P4[4..0]
#define WF_PSE_TOP_INT_N9_ERR3_MASK_EN_DATA_OPER_ERR_TYPE_P4_SHFT 0
...
/* =====================================================================================
  ...
  ---QUEUE_EMPTY (0x820c8000 + 0xB0)---
    ...
    RLS2_Q_EMTPY[30]             - (RO) Release2 queue empty status
...
#define WF_PSE_TOP_QUEUE_EMPTY_RLS2_Q_EMTPY_MASK               0x40000000                // RLS2_Q_EMTPY[30]
#define WF_PSE_TOP_QUEUE_EMPTY_RLS2_Q_EMTPY_SHFT               30
...
/* =====================================================================================
  ...
  ---QUEUE_EMPTY_1 (0x820c8000 + 0xBC)---

    MDP_TDPIOC_QUEUE_EMPTY[0]    - (RO) MDP TDPIOC queue empty status for Band 0
    MDP_RDPIOC_QUEUE_EMPTY[1]    - (RO) MDP RDPIOC queue empty status for Band 0
    MDP_TDPIOC1_QUEUE_EMPTY[2]   - (RO) MDP TDPIOC queue empty status for Band 1
    MDP_RDPIOC1_QUEUE_EMPTY[3]   - (RO) MDP RDPIOC queue empty status for Band 1
    MDP_TDPIOC2_QUEUE_EMPTY[4]   - (RO) MDP TDPIOC queue empty status for Band 2
    MDP_RDPIOC2_QUEUE_EMPTY[5]   - (RO) MDP RDPIOC queue empty status for Band 2
    RESERVED6[6]                 - (RO) Reserved bits
    MDP_RDPIOC3_QUEUE_EMPTY[7]   - (RO) MDP RDPIOC queue empty status for Band 3
    MDP_TX2_QUEUE_EMPTY[8]       - (RO) MDP TX queue empty status for Band 2
    SEC_TX2_QUEUE_EMPTY[9]       - (RO) SEC TX queue empty status for Band 2
    MDP_TXIOC2_QUEUE_EMPTY[10]   - (RO) MDP TXIOC queue empty status for Band 2
    MDP_RXIOC2_QUEUE_EMPTY[11]   - (RO) MDP RXIOC queue empty status for Band 2
    RESERVED12[14..12]           - (RO) Reserved bits
    MDP_RXIOC3_QUEUE_EMPTY[15]   - (RO) MDP RXIOC queue empty status for Band 3
    HIF_0_EMPTY[16]              - (RO) HIF queue 0 empty status
    HIF_1_EMPTY[17]              - (RO) HIF queue 1 empty status
    HIF_2_EMPTY[18]              - (RO) HIF queue 2 empty status
    HIF_3_EMPTY[19]              - (RO) HIF queue 3 empty status
    HIF_4_EMPTY[20]              - (RO) HIF queue 4 empty status
    HIF_5_EMPTY[21]              - (RO) HIF queue 5 empty status
    HIF_6_EMPTY[22]              - (RO) HIF queue 6 empty status
    HIF_7_EMPTY[23]              - (RO) HIF queue 7 empty status
...
/* =====================================================================================
  ...
  ---QUEUE_EMPTY_MASK_1 (0x820c8000 + 0xC0)---

    PSE_QUEUE_EMPTY_MASK[31..0]  - (RW) Mask UMAC queue head FID to NULL
                                     bit 31 : reserved
                                     bit 30 : mask bn3_rdpioc head FID to NULL
                                     bit 29 : mask bn3_rxioc head FID to NULL
                                     bit 28 : mask bn2_rdpioc head FID to NULL
                                     bit 27 : mask bn2_tdpioc head FID to NULL
                                     bit 26 : mask bn2_rxioc head FID to NULL
                                     bit 25 : mask bn2_txioc head FID to NULL
                                     bit 24 : mask bn2_sec_tx head FID to NULL
                                     bit 23 : mask bn2_mdp_tx head FID to NULL
                                     bit 22 : mask bn1_rdpioc head FID to NULL
                                     bit 21 : mask bn1_tdpioc head FID to NULL
                                     bit 20 : mask bn1_rxioc head FID to NULL
                                     bit 19 : mask bn1_txioc head FID to NULL
                                     bit 18 : mask bn1_sec_tx head FID to NULL
                                     bit 17 : mask bn1_mdp_tx head FID to NULL
                                     bit 16 : mask release head FID to NULL
                                     bit 15 : mask release2 head FID to NULL
                                     bit 14 : mask bn0_rdpioc head FID to NULL
                                     bit 13 : mask bn0_tdpioc head FID to NULL
                                     bit 12 : mask bn0_rxioc head FID to NULL
                                     bit 11 : mask bn0_txioc head FID to NULL
                                     bit 10 : reserved
                                     bit 9 : mask sec_rx head FID to NULL
                                     bit 8 : mask bn0_sec_tx head FID to NULL
                                     bit 7 : mask mdp_rx head FID to NULL
                                     bit 6 : mask bn0_mdp_tx head FID to NULL
                                     bit 5~0 : reserved

 =====================================================================================*/
#define WF_PSE_TOP_QUEUE_EMPTY_MASK_1_PSE_QUEUE_EMPTY_MASK_ADDR WF_PSE_TOP_QUEUE_EMPTY_MASK_1_ADDR
#define WF_PSE_TOP_QUEUE_EMPTY_MASK_1_PSE_QUEUE_EMPTY_MASK_MASK 0xFFFFFFFF                // PSE_QUEUE_EMPTY_MASK[31..0]
#define WF_PSE_TOP_QUEUE_EMPTY_MASK_1_PSE_QUEUE_EMPTY_MASK_SHFT 0
...
/* =====================================================================================
  ...
  ---GROUP_REFILL_CTRL (0x820c8000 + 0x108)---
    ...
    GROUP_REFILL_PRI[13..0]      - (RW) group refill priority control
    RESERVED14[15..14]           - (RO) Reserved bits
    DIS_GROUP_REFILL[29..16]     - (RW) group quota refill enable control
...
/* =====================================================================================
  ...
  ---FREEPG_START_END (0x820c8000 + 0x10C)---
    ...
    FREEPG_START[12..0]          - (RW) Start page setting of free pages
    RESERVED13[15..13]           - (RO) Reserved bits
    FREEPG_END[28..16]           - (RW) End page setting of free page
...
/* =====================================================================================
  ...
  ---PG_HIF1_GROUP (0x820c8000 + 0x114)---
    ...
    HIF1_MIN_QUOTA[12..0]        - (RW) Min. quota of HIF 1 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    HIF1_MAX_QUOTA[28..16]       - (RW) Max. quota of HIF 1 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PG_CPU_GROUP (0x820c8000 + 0x118)---
    ...
    CPU_MIN_QUOTA[12..0]         - (RW) Min. quota of CPU group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    CPU_MAX_QUOTA[28..16]        - (RW) Max. quota of CPU group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PG_PLE_GROUP (0x820c8000 + 0x11C)---
    ...
    PLE_MIN_QUOTA[12..0]         - (RW) Min. quota of PLE group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    PLE_MAX_QUOTA[28..16]        - (RW) Max. quota of PLE group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PG_LMAC0_GROUP (0x820c8000 + 0x124)---
    ...
    LMAC0_MIN_QUOTA[12..0]       - (RW) Min. quota of LMAC 0 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    LMAC0_MAX_QUOTA[28..16]      - (RW) Max. quota of LMAC 0 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PG_LMAC1_GROUP (0x820c8000 + 0x128)---
    ...
    LMAC1_MIN_QUOTA[12..0]       - (RW) Min. quota of LMAC 1 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    LMAC1_MAX_QUOTA[28..16]      - (RW) Max. quota of LMAC 1 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PG_LMAC2_GROUP (0x820c8000 + 0x12C)---
    ...
    LMAC2_MIN_QUOTA[12..0]       - (RW) Min. quota of LMAC 2 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    LMAC2_MAX_QUOTA[28..16]      - (RW) Max. quota of LMAC 2 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PG_LMAC3_GROUP (0x820c8000 + 0x130)---
    ...
    LMAC3_MIN_QUOTA[12..0]       - (RW) Min. quota of LMAC 3 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    LMAC3_MAX_QUOTA[28..16]      - (RW) Max. quota of LMAC 3 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PG_MDP_GROUP (0x820c8000 + 0x134)---
    ...
    MDP_MIN_QUOTA[12..0]         - (RW) Min. quota of MDP group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    MDP_MAX_QUOTA[28..16]        - (RW) Max. quota of MDP group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PG_MDP1_GROUP (0x820c8000 + 0x138)---
    ...
    MDP1_MIN_QUOTA[12..0]        - (RW) Min. quota of MDP1 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    MDP1_MAX_QUOTA[28..16]       - (RW) Max. quota of MDP1 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PG_MDP2_GROUP (0x820c8000 + 0x13C)---
    ...
    MDP2_MIN_QUOTA[12..0]        - (RW) Min. quota of MDP2 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    MDP2_MAX_QUOTA[28..16]       - (RW) Max. quota of MDP2 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PG_HIF2_GROUP (0x820c8000 + 0x140)---
    ...
    HIF2_MIN_QUOTA[12..0]        - (RW) Min. quota of HIF 2 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    HIF2_MAX_QUOTA[28..16]       - (RW) Max. quota of HIF 2 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PG_CPU1_GROUP (0x820c8000 + 0x148)---

    CPU1_MIN_QUOTA[12..0]        - (RW) Min. quota of CPU1 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    CPU1_MAX_QUOTA[28..16]       - (RW) Max. quota of CPU1 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits

 =====================================================================================*/
#define WF_PSE_TOP_PG_CPU1_GROUP_CPU1_MAX_QUOTA_ADDR           WF_PSE_TOP_PG_CPU1_GROUP_ADDR
#define WF_PSE_TOP_PG_CPU1_GROUP_CPU1_MAX_QUOTA_MASK           0x1FFF0000                // CPU1_MAX_QUOTA[28..16]
#define WF_PSE_TOP_PG_CPU1_GROUP_CPU1_MAX_QUOTA_SHFT           16
#define WF_PSE_TOP_PG_CPU1_GROUP_CPU1_MIN_QUOTA_ADDR           WF_PSE_TOP_PG_CPU1_GROUP_ADDR
#define WF_PSE_TOP_PG_CPU1_GROUP_CPU1_MIN_QUOTA_MASK           0x00001FFF                // CPU1_MIN_QUOTA[12..0]
#define WF_PSE_TOP_PG_CPU1_GROUP_CPU1_MIN_QUOTA_SHFT           0

/* =====================================================================================

  ---HIF0_PG_INFO (0x820c8000 + 0x150)---

    HIF0_RSV_CNT[12..0]          - (RO) Reserved pages of HIF 0 group
    RESERVED13[15..13]           - (RO) Reserved bits
    HIF0_SRC_CNT[28..16]         - (RO) Used pages of HIF 0 group
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---HIF1_PG_INFO (0x820c8000 + 0x154)---
    ...
    HIF1_RSV_CNT[12..0]          - (RO) Reserved pages of HIF 1 group
    RESERVED13[15..13]           - (RO) Reserved bits
    HIF1_SRC_CNT[28..16]         - (RO) Used pages of HIF 1 group
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---CPU_PG_INFO (0x820c8000 + 0x158)---
    ...
    CPU_RSV_CNT[12..0]           - (RO) Reserved pages of CPU group
    RESERVED13[15..13]           - (RO) Reserved bits
    CPU_SRC_CNT[28..16]          - (RO) Used pages of CPU group
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PLE_PG_INFO (0x820c8000 + 0x15C)---
    ...
    PLE_RSV_CNT[12..0]           - (RO) Reserved pages of PLE group
    RESERVED13[15..13]           - (RO) Reserved bits
    PLE_SRC_CNT[28..16]          - (RO) Used pages of PLE group
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---LMAC0_PG_INFO (0x820c8000 + 0x164)---
    ...
    LMAC0_RSV_CNT[12..0]         - (RO) Reserved pages of LMAC 0 group
    RESERVED13[15..13]           - (RO) Reserved bits
    LMAC0_SRC_CNT[28..16]        - (RO) Used pages of LMAC 0 group
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---LMAC1_PG_INFO (0x820c8000 + 0x168)---
    ...
    LMAC1_RSV_CNT[12..0]         - (RO) Reserved pages of LMAC 1 group
    RESERVED13[15..13]           - (RO) Reserved bits
    LMAC1_SRC_CNT[28..16]        - (RO) Used pages of LMAC 1 group
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---LMAC2_PG_INFO (0x820c8000 + 0x16C)---
    ...
    LMAC2_RSV_CNT[12..0]         - (RO) Reserved pages of LMAC 2 group
    RESERVED13[15..13]           - (RO) Reserved bits
    LMAC2_SRC_CNT[28..16]        - (RO) Used pages of LMAC 2 group
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---LMAC3_PG_INFO (0x820c8000 + 0x170)---
    ...
    LMAC3_RSV_CNT[12..0]         - (RO) Reserved pages of LMAC 3 group
    RESERVED13[15..13]           - (RO) Reserved bits
    LMAC3_SRC_CNT[28..16]        - (RO) Used pages of LMAC 3 group
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---MDP_PG_INFO (0x820c8000 + 0x174)---
    ...
    MDP_RSV_CNT[12..0]           - (RO) Reserved pages of MDP group
    RESERVED13[15..13]           - (RO) Reserved bits
    MDP_SRC_CNT[28..16]          - (RO) Used pages of MDP group
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---MDP1_PG_INFO (0x820c8000 + 0x178)---
    ...
    MDP1_RSV_CNT[12..0]          - (RO) Reserved pages of MDP 1 group
    RESERVED13[15..13]           - (RO) Reserved bits
    MDP1_SRC_CNT[28..16]         - (RO) Used pages of MDP 1 group
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---MDP2_PG_INFO (0x820c8000 + 0x17C)---
    ...
    MDP2_RSV_CNT[12..0]          - (RO) Reserved pages of MDP 2 group
    RESERVED13[15..13]           - (RO) Reserved bits
    MDP2_SRC_CNT[28..16]         - (RO) Used pages of MDP 2 group
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---HIF2_PG_INFO (0x820c8000 + 0x180)---
    ...
    HIF2_RSV_CNT[12..0]          - (RO) Reserved pages of HIF 2 group
    RESERVED13[15..13]           - (RO) Reserved bits
    HIF2_SRC_CNT[28..16]         - (RO) Used pages of HIF 2 group
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---MDP3_PG_INFO (0x820c8000 + 0x184)---

    MDP3_RSV_CNT[12..0]          - (RO) Reserved pages of MDP 3 group
    RESERVED13[15..13]           - (RO) Reserved bits
    MDP3_SRC_CNT[28..16]         - (RO) Used pages of MDP 3 group
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---CPU1_PG_INFO (0x820c8000 + 0x188)---

    CPU1_RSV_CNT[12..0]          - (RO) Reserved pages of CPU 1 group
    RESERVED13[15..13]           - (RO) Reserved bits
    CPU1_SRC_CNT[28..16]         - (RO) Used pages of CPU 1 group
    RESERVED29[31..29]           - (RO) Reserved bits

 =====================================================================================*/
#define WF_PSE_TOP_CPU1_PG_INFO_CPU1_SRC_CNT_ADDR              WF_PSE_TOP_CPU1_PG_INFO_ADDR
#define WF_PSE_TOP_CPU1_PG_INFO_CPU1_SRC_CNT_MASK              0x1FFF0000                // CPU1_SRC_CNT[28..16]
#define WF_PSE_TOP_CPU1_PG_INFO_CPU1_SRC_CNT_SHFT              16
#define WF_PSE_TOP_CPU1_PG_INFO_CPU1_RSV_CNT_ADDR              WF_PSE_TOP_CPU1_PG_INFO_ADDR
#define WF_PSE_TOP_CPU1_PG_INFO_CPU1_RSV_CNT_MASK              0x00001FFF                // CPU1_RSV_CNT[12..0]
#define WF_PSE_TOP_CPU1_PG_INFO_CPU1_RSV_CNT_SHFT              0
...
/* =====================================================================================
  ...
  ---FL_QUE_CTRL_0 (0x820c8000 + 0x1B0)---
    ...
    Q_BUF_PID[17..16]            - (RW) Address of queue structure buffer PID
...
/* =====================================================================================
  ...
  ---FL_QUE_CTRL_1 (0x820c8000 + 0x1B4)---
    ...
    NEXT_FID[12..0]              - (RO) Next frame ID of FL_BUFFER_ADDR
    RESERVED13[15..13]           - (RO) Reserved bits
    PREV_FID[28..16]             - (RO) Previous frame ID of FL_BUFFER_ADDR
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---FL_QUE_CTRL_2 (0x820c8000 + 0x1B8)---
    ...
    QUEUE_HEAD_FID[12..0]        - (RO) Head frame ID of quest queue setting in 0x01b0[15:0]
    RESERVED13[15..13]           - (RO) Reserved bits
    QUEUE_TAIL_FID[28..16]       - (RO) Tail frame ID of quest queue setting in 0x01b0[15:0]
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---FL_QUE_CTRL_3 (0x820c8000 + 0x1BC)---
    ...
    QUEUE_PKT_NUM[12..0]         - (RO) Total packet number of queue  setting in 0x1b0[15:0]
    RESERVED13[31..13]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---FL_QUE_CTRL_4 (0x820c8000 + 0x1C0)---

    FL_BUFFER_ADDR[12..0]        - (RW) Frame address of read previous frame/next frame
    RESERVED13[31..13]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PL_QUE_CTRL_0 (0x820c8000 + 0x1C4)---

    NEXT_PAGE[12..0]             - (RO) Next page of the PL_BUFFER_ADDR
    RESERVED13[15..13]           - (RO) Reserved bits
    PL_BUFFER_ADDR[28..16]       - (RW) Page address of read next page
...
/* =====================================================================================
  ...
  ---PLE_ENQ_PKT_NUM (0x820c8000 + 0x1F0)---
    ...
    PLE_ENQ_HIF_Q_SEL[20..16]    - (RW) Select HIF queue which is  PLE port enqueue to.
                                     5'h0 : HIF queue 0
                                     5'h1 : HIF queue 1
                                     And so on
                                     5'h10 : HIF queue 16
                                     5'h11~5'h1D : reserved
                                     5'h1E : allocate-q_op pair count
                                     5'h1F : release queue
...
#define WF_PSE_TOP_PLE_ENQ_PKT_NUM_PLE_ENQ_HIF_Q_SEL_MASK      0x001F0000                // PLE_ENQ_HIF_Q_SEL[20..16]
...
/* =====================================================================================
  ...
  ---CPU_ENQ_PKT_NUM (0x820c8000 + 0x1F4)---
    ...
    CPU_ENQ_HIF_Q_SEL[20..16]    - (RW) Select HIF queue which is  CPU port enqueue to.
                                     5'h0 : HIF queue 0
                                     5'h1 : HIF queue 1
                                     And so on.
                                     5'h10 : HIF queue 16
...
#define WF_PSE_TOP_CPU_ENQ_PKT_NUM_CPU_ENQ_HIF_Q_SEL_MASK      0x001F0000                // CPU_ENQ_HIF_Q_SEL[20..16]
...
/* =====================================================================================
  ...
  ---LMAC_ENQ_PKT_NUM (0x820c8000 + 0x1F8)---
    ...
    LMAC_ENQ_HIF_Q_SEL[20..16]   - (RW) Select HIF queue which is  LMAC port enqueue to.
                                     5'h0 : HIF queue 0
                                     5'h1 : HIF queue 1
                                     And so on
                                     5'h10 : HIF queue 16
                                     5'h11~5'h1C : reserved
                                     5'h1D : SEC Rx queue
                                     5'h1E : allocate-q_op pair count
                                     5'h1F : release queue
    RESERVED21[31..21]           - (RO) Reserved bits
...
#define WF_PSE_TOP_LMAC_ENQ_PKT_NUM_LMAC_ENQ_HIF_Q_SEL_MASK    0x001F0000                // LMAC_ENQ_HIF_Q_SEL[20..16]
...
/* =====================================================================================
  ...
  ---MDP_ENQ_PKT_NUM (0x820c8000 + 0x200)---
    ...
    MDP_ENQ_HIF_Q_SEL[31..16]    - (RW) Select HIF queue which is  MDP port enqueue to.
                                     ...
                                     And so on.
                                     16'h10 : HIF queue 16
                                     16'h11~16'h1D : reserved
                                     16'h1E : allocate-q_op pair count
                                     16'h1F : release queue
...
/* =====================================================================================
  ...
  ---MDP_ENQ_PKT_NUM_1 (0x820c8000 + 0x208)---

    Q_PKT_NUM[15..0]             - (RO) The packets numbers of MDP port enqueue to the queue.
    Q_SEL[31..16]                - (RW) Select queue which is  MDP port enqueue to.
...
/* =====================================================================================
  ...
  ---HIF_ENQ_PKT_NUM_1 (0x820c8000 + 0x20C)---

    HIF_ENQ_PKT_NUM[15..0]       - (RO) The packets numbers of MDP port enqueue to HIF queue.
    HIF_ENQ_SEL[20..16]          - (RW) Select queue which is  HIF port enqueue to.
                                     5'h0 : CPU queue
                                     5'h1 : MDP queue
                                     5'h2~5'h1D : reserved
                                     5'h1E : allocate-q_op pair count
...
#define WF_PSE_TOP_HIF_ENQ_PKT_NUM_1_HIF_ENQ_SEL_MASK          0x001F0000                // HIF_ENQ_SEL[20..16]
#define WF_PSE_TOP_HIF_ENQ_PKT_NUM_1_HIF_ENQ_SEL_SHFT          16
#define WF_PSE_TOP_HIF_ENQ_PKT_NUM_1_HIF_ENQ_PKT_NUM_ADDR      WF_PSE_TOP_HIF_ENQ_PKT_NUM_1_ADDR
#define WF_PSE_TOP_HIF_ENQ_PKT_NUM_1_HIF_ENQ_PKT_NUM_MASK      0x0000FFFF                // HIF_ENQ_PKT_NUM[15..0]
#define WF_PSE_TOP_HIF_ENQ_PKT_NUM_1_HIF_ENQ_PKT_NUM_SHFT      0

/* =====================================================================================

  ---RL_BUF_CTRL_0 (0x820c8000 + 0x210)---

    RELAY_BUF_ADDR[12..0]        - (RW) Read address of relay buffer
...
/* =====================================================================================
  ...
  ---RL_BUF_CTRL_1 (0x820c8000 + 0x214)---
    ...
    PKT_TAIL_PAGE[26..14]        - (RO) Tail page of the packet with head page being the relay buffer address
    RESERVED27[27]               - (RO) Reserved bits
    RESV_GRP_ID[31..28]          - (RO) Group ID of reserved page used by FID
...
/* =====================================================================================
  ...
  ---SEC_ENQ_PKT_NUM (0x820c8000 + 0x220)---

    SEC_ENQ_PKT_NUM[15..0]       - (RO) The packets numbers of MDP port enqueue to HIF queue.
    SEC_ENQ_SEL[20..16]          - (RW) Select queue which is  SEC port enqueue to.
                                     5'h0 : RXIOC queue
                                     5'h1 : TXIOC queue
                                     5'h2~5'h1D : reserved
                                     5'h1E : allocate-q_op pair count
...
#define WF_PSE_TOP_SEC_ENQ_PKT_NUM_SEC_ENQ_SEL_MASK            0x001F0000                // SEC_ENQ_SEL[20..16]
#define WF_PSE_TOP_SEC_ENQ_PKT_NUM_SEC_ENQ_SEL_SHFT            16
#define WF_PSE_TOP_SEC_ENQ_PKT_NUM_SEC_ENQ_PKT_NUM_ADDR        WF_PSE_TOP_SEC_ENQ_PKT_NUM_ADDR
#define WF_PSE_TOP_SEC_ENQ_PKT_NUM_SEC_ENQ_PKT_NUM_MASK        0x0000FFFF                // SEC_ENQ_PKT_NUM[15..0]
#define WF_PSE_TOP_SEC_ENQ_PKT_NUM_SEC_ENQ_PKT_NUM_SHFT        0
...
/* =====================================================================================
  ...
  ---PSE_WFDMA_BUF_CTRL (0x820c8000 + 0x250)---
    ...
    WFDMA_RX_PCIE_ACT_TH[28..16] - (RW) RX PCIE act threshold
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PSE_MISC_FUNC_CTRL (0x820c8000 + 0x254)---
    ...
    PSE_DOUBLE_RELEASE_MODE[0]   - (RW) Double release mode control
...
/* =====================================================================================
  ...
  ---PSE_MODULE_CKG_DIS (0x820c8000 + 0x258)---
    ...
    RESERVED14[29..14]           - (RO) Reserved bits
    DIS_PSE_SRAM_MBIST_DYN_CKG[30] - (RW) Disable control of PSE MBIST SRAM dynamic clock gating function
...
/* =====================================================================================
  ...
  ---PSE_MBIST_RP_FUSE (0x820c8000 + 0x2B0)---
    ...
    REG_FUSE_LOAD[16]            - (RW) MBIST FUSE setting
...
/* =====================================================================================
  ...
  ---PSE_MBIST_RP_FUSE_1 (0x820c8000 + 0x2B4)---
    ...
    WF_UMAC_TOP_MBIST_PREFUSE_0[15..0] - (RW) Memory MBIST Pre-FUSE fuse load output
    WF_UMAC_TOP_MBIST_PREFUSE_D_0[31..16] - (RO) Memory MBIST Pre-FUSE prefuse input
...
/* =====================================================================================
  ...
  ---PSE_MBIST_RP_FUSE_2 (0x820c8000 + 0x2BC)---

    WF_UMAC_TOP_MBIST_PREFUSE_1[15..0] - (RW) MBIST PRE-FUSE load output
    WF_UMAC_TOP_MBIST_PREFUSE_D_1[31..16] - (RO) MBIST PRE-FUSE input
...
/* =====================================================================================
  ...
  ---PSE_MBIST_RP_FUSE_3 (0x820c8000 + 0x2E0)---

    WF_UMAC_TOP_MBIST_PREFUSE_3[15..0] - (RW) MBIST PRE-FUSE load output
    WF_UMAC_TOP_MBIST_PREFUSE_D_3[31..16] - (RO) MBIST PRE-FUSE input
...
/* =====================================================================================
  ...
  ---PSE_MBIST_RP_FUSE_4 (0x820c8000 + 0x2E4)---

    WF_UMAC_TOP_MBIST_PREFUSE_4[15..0] - (RW) MBIST PRE-FUSE load output
    WF_UMAC_TOP_MBIST_PREFUSE_D_4[31..16] - (RO) MBIST PRE-FUSE input
...
/* =====================================================================================
  ...
  ---PSE_MBIST_RP_FUSE_5 (0x820c8000 + 0x2E8)---

    WF_UMAC_TOP_MBIST_PREFUSE_5[15..0] - (RW) MBIST PRE-FUSE load output
    WF_UMAC_TOP_MBIST_PREFUSE_D_5[31..16] - (RO) MBIST PRE-FUSE input
...
/* =====================================================================================
  ...
  ---DBG_CTRL (0x820c8000 + 0x2EC)---

    DBG_AHB_WDATA_LSB_SEL[1..0]  - (RW) AHB Write Data Select
    DBG_AHB_WDATA_MSB_SEL[3..2]  - (RW) AHB Write Data Select
    DBG_BN_SEL[4]                - (RW) Band Select
    DBG_RSV0[5]                  - (RW) reserved
    DBG_SEC_TX_RD_VLD_SEL[7..6]  - (RW) SEC Tx Read Valid Select
    DBG_WF_TX_RD_VLD_SEL[9..8]   - (RW) LMAC Tx Read Valid Select
    DBG_RSV1[31..10]             - (RW) reserved
...
/* =====================================================================================
  ...
  ---C_GET_FID_0 (0x820c8000 + 0x310)---
    ...
    QUEUE_FRAME_ID[15..0]        - (RW) Frame ID for get command
                                     ...
                                     2'h1: CPU port
                                     2'h2: LMAC port
                                     QUEUE_FRAME_ID[11:0] = WLANID
                                     At GET_FRAME_TYPE = 2'h2/2'h3:
                                     QUEUE_FRAME_ID[12:0] = reference FID
...
/* =====================================================================================
  ...
  ---C_GET_FID_1 (0x820c8000 + 0x314)---
    ...
    GET_RETURN_FID[12..0]        - (RO) Return frame ID
...
/* =====================================================================================
  ...
  ---C_EN_QUEUE_1 (0x820c8000 + 0x324)---
    ...
    CUR_LIST_FID_START[12..0]    - (RW) Start frame ID of enqueue operation list, enqueue FID of enqueue operation
    RESERVED13[15..13]           - (RO) Reserved bits
    CUR_LIST_FID_END[28..16]     - (RW) End frame ID of enqueue operation list
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---C_EN_QUEUE_2 (0x820c8000 + 0x328)---
    ...
    TARGET_FID[12..0]            - (RW) Target reference FID for enqueue operation
    RESERVED13[31..13]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---C_DE_QUEUE_1 (0x820c8000 + 0x334)---
    ...
    CUR_LIST_FID_START[12..0]    - (RW) Start frame ID of dequeue operation list, enqueue start FID of enqueue operation
                                     Only valid in Deq&Enq type.
    RESERVED13[15..13]           - (RO) Reserved bits
    CUR_LIST_FID_END[28..16]     - (RW) End framd ID of dequeue operation list, enqueue end FID of enqueue operation
                                     Only valid in Deq&Enq type.
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---C_DE_QUEUE_3 (0x820c8000 + 0x33C)---
    ...
    DEQ_HEAD_FDI[12..0]          - (RO) Head FID got from dequeue command
    RESERVED13[14..13]           - (RO) Reserved bits
    DEQ_EMPTY[15]                - (RO) Queue empty after dequeue command is executed
    DEQ_TAIL_FID[28..16]         - (RO) Last FID got from dequeue command
    RESERVED29[30..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---C_DE_QUEUE_4 (0x820c8000 + 0x340)---
    ...
    DEQ_ENQ_REF_FID[12..0]       - (RW) Reference frame ID for enqueue command
                                     Only valid in Deq&Enq type.
    RESERVED13[31..13]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---ALLOCATE_1 (0x820c8000 + 0x354)---
    ...
    ALLOCATE_FID[12..0]          - (RO) Return frame ID for allocate buffer command
    RESERVED13[30..13]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---FREEPG_CNT (0x820c8000 + 0x3A0)---

    FREEPG_CNT[12..0]            - (RO) Total page number of free
    RESERVED13[15..13]           - (RO) Reserved bits
    FFA_CNT[28..16]              - (RO) Free page numbers of free for all
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---FREEPG_HEAD_TAIL (0x820c8000 + 0x3A4)---

    FREEPG_HEAD[12..0]           - (RO) Head page of free page list
    RESERVED13[15..13]           - (RO) Reserved bits
    FREEPG_TAIL[28..16]          - (RO) Tail page of free page list
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PSE_SEEK_CR_01 (0x820c8000 + 0x3D4)---
    ...
    RESERVED23[23]               - (RO) Reserved bits
    PSE_RLS_CS[26..24]           - (RO) PSE debug state for RLS_CS
    RESERVED27[31..27]           - (RO) Reserved bits

 =====================================================================================*/
#define WF_PSE_TOP_PSE_SEEK_CR_01_PSE_RLS_CS_ADDR              WF_PSE_TOP_PSE_SEEK_CR_01_ADDR
#define WF_PSE_TOP_PSE_SEEK_CR_01_PSE_RLS_CS_MASK              0x07000000                // PSE_RLS_CS[26..24]
...
/* =====================================================================================
  ...
  ---PSE_SEEK_CR_09 (0x820c8000 + 0x3F4)---
    ...
    DOUBLE_RLS_FID[28..16]       - (RO) PSE double RLS FID PAGE
    RESERVED29[30..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---PSE_SEEK_CR_10 (0x820c8000 + 0x3F8)---

    PSE_PL1_ARB_CS[2..0]         - (RO) PSE debug state for PL_ARB1_CS
    RESERVED3[3]                 - (RO) Reserved bits
    PSE_PL_INIT_CS[5..4]         - (RO) PSE debug state for PL_INIT_CS
    RESERVED6[7..6]              - (RO) Reserved bits
    PSE_PL1_GNEXT_CS[8]          - (RO) PSE debug state for PL_GNEXT1_CS
    RESERVED9[11..9]             - (RO) Reserved bits
    PSE_PL1_GBUF_CS[14..12]      - (RO) PSE debug state for PL_GBUF1_CS
    RESERVED15[15]               - (RO) Reserved bits
    PSE_PL1_RLS_CS[17..16]       - (RO) PSE debug state for PL_RLS1_CS
    RESERVED18[19..18]           - (RO) Reserved bits
    PSE_PL_REFILL_CS[22..20]     - (RO) PSE debug state for PL_REFILL_CS
    RESERVED23[23]               - (RO) Reserved bits
    PSE_RLS_CS[26..24]           - (RO) PSE debug state for RLS_CS
...
#define WF_PSE_TOP_PSE_SEEK_CR_10_PSE_RLS_CS_MASK              0x07000000                // PSE_RLS_CS[26..24]
...
/* =====================================================================================
  ...
  ---PSE_SEEK_CR_11 (0x820c8000 + 0x3FC)---

    PORT_DATA_OPER_ERROR_FID[12..0] - (RO) Data operation error FID
    RESERVED13[14..13]           - (RO) Reserved bits
    PORT_DATA_OPER_ERROR_PXE[15] - (RO) Data operation error PLE/PSE FID
    RESERVED16[23..16]           - (RO) Reserved bits
    PORT_DATA_OPER_ERROR_TYPE[26..24] - (RO) Data operation error type
    RESERVED27[27]               - (RO) Reserved bits
    PORT_SEL[31..28]             - (RW) Data operation error port select

 =====================================================================================*/
#define WF_PSE_TOP_PSE_SEEK_CR_11_PORT_SEL_ADDR                WF_PSE_TOP_PSE_SEEK_CR_11_ADDR
#define WF_PSE_TOP_PSE_SEEK_CR_11_PORT_SEL_MASK                0xF0000000                // PORT_SEL[31..28]
#define WF_PSE_TOP_PSE_SEEK_CR_11_PORT_SEL_SHFT                28
#define WF_PSE_TOP_PSE_SEEK_CR_11_PORT_DATA_OPER_ERROR_TYPE_ADDR WF_PSE_TOP_PSE_SEEK_CR_11_ADDR
#define WF_PSE_TOP_PSE_SEEK_CR_11_PORT_DATA_OPER_ERROR_TYPE_MASK 0x07000000                // PORT_DATA_OPER_ERROR_TYPE[26..24]
#define WF_PSE_TOP_PSE_SEEK_CR_11_PORT_DATA_OPER_ERROR_TYPE_SHFT 24
#define WF_PSE_TOP_PSE_SEEK_CR_11_PORT_DATA_OPER_ERROR_PXE_ADDR WF_PSE_TOP_PSE_SEEK_CR_11_ADDR
#define WF_PSE_TOP_PSE_SEEK_CR_11_PORT_DATA_OPER_ERROR_PXE_MASK 0x00008000                // PORT_DATA_OPER_ERROR_PXE[15]
#define WF_PSE_TOP_PSE_SEEK_CR_11_PORT_DATA_OPER_ERROR_PXE_SHFT 15
#define WF_PSE_TOP_PSE_SEEK_CR_11_PORT_DATA_OPER_ERROR_FID_ADDR WF_PSE_TOP_PSE_SEEK_CR_11_ADDR
#define WF_PSE_TOP_PSE_SEEK_CR_11_PORT_DATA_OPER_ERROR_FID_MASK 0x00001FFF                // PORT_DATA_OPER_ERROR_FID[12..0]
#define WF_PSE_TOP_PSE_SEEK_CR_11_PORT_DATA_OPER_ERROR_FID_SHFT 0
