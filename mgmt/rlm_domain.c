...
static const uint16_t g_u2CountryGroup1[] = {
	...
	COUNTRY_CODE_HT, COUNTRY_CODE_IL, COUNTRY_CODE_IN, COUNTRY_CODE_IO,
	...
	COUNTRY_CODE_UA, COUNTRY_CODE_VC, COUNTRY_CODE_VG, COUNTRY_CODE_VN,
	COUNTRY_CODE_VU, COUNTRY_CODE_WS, COUNTRY_CODE_YE, COUNTRY_CODE_ZA
};
...
static const uint16_t g_u2CountryGroup19[] = {
	COUNTRY_CODE_AE, COUNTRY_CODE_CK, COUNTRY_CODE_GB, COUNTRY_CODE_HK,
	COUNTRY_CODE_KI, COUNTRY_CODE_KR, COUNTRY_CODE_NZ, COUNTRY_CODE_TL
};
static const uint16_t g_u2CountryGroup20[] = {
	COUNTRY_CODE_AS, COUNTRY_CODE_PR, COUNTRY_CODE_US
};
static const uint16_t g_u2CountryGroup21[] = {
	COUNTRY_CODE_ID, COUNTRY_CODE_NP
};
static const uint16_t g_u2CountryGroup22[] = {
	COUNTRY_CODE_CL, COUNTRY_CODE_CR, COUNTRY_CODE_TW
};
