...
#if defined(_HIF_USB)
static u_int8_t usb_mt6653_ConninfraOnRdableChk(struct ADAPTER *ad)
{
...
static u_int8_t usb_mt6653_ConninfraOffRdableChk(struct ADAPTER *ad)
{
...
static u_int8_t usb_mt6653_ConninfraAp2WfRdableChk(struct ADAPTER *ad)
{
...
static void usb_mt6653_dumpConninfraPwrDbg(struct ADAPTER *ad)
{
...
static void usb_mt6653_dumpConninfraBusDbg(struct ADAPTER *ad,
	u_int8_t fgOnDomain)
{
...
static void usb_mt6653_dumpConninfraClkDbg(struct ADAPTER *ad,
	u_int8_t fgOnDomain)
{
...
static void usb_mt6653_dumpConninfraReg(struct ADAPTER *ad)
{
	uint32_t u4RdAddr, u4Val = 0;
	u_int8_t fgStatus = FALSE;

	if (!usb_mt6653_ConninfraOnRdableChk(ad))
		return;
	...
	/* Dump on domain */
	usb_mt6653_dumpConninfraBusDbg(ad, TRUE);
	usb_mt6653_dumpConninfraClkDbg(ad, TRUE);

	if (!usb_mt6653_ConninfraOffRdableChk(ad))
		return;

	/* Dump off domain */
	usb_mt6653_dumpConninfraPwrDbg(ad);
	usb_mt6653_dumpConninfraBusDbg(ad, FALSE);
	usb_mt6653_dumpConninfraClkDbg(ad, FALSE);
}

static void usb_mt6653_dumpWfTopMiscOn(struct ADAPTER *ad)
{
	uint32_t u4WrVal = 0, u4Val = 0, u4Idx, u4RdAddr, u4WrAddr;
	u_int8_t fgStatus = FALSE;
	uint32_t au4List[] = {
...
static void usb_mt6653_dumpWfTopMiscVon(struct ADAPTER *ad)
{
	uint32_t u4WrVal = 0, u4Val = 0, u4Idx, u4RdAddr, u4WrAddr;
	u_int8_t fgStatus = FALSE;
	uint32_t au4List[] = {
...
static void usb_mt6653_dumpWfTopCfgon(struct ADAPTER *ad)
{
	uint32_t u4RdAddr, u4Val = 0, u4Idx;
	u_int8_t fgStatus = FALSE;
	uint32_t au4List[] = {
...
static void usb_mt6653_dumpHostVdnrTimeoutInfo(struct ADAPTER *ad)
{
	uint32_t u4WrVal = 0, u4Val = 0, u4Idx, u4RdAddr, u4WrAddr;
	u_int8_t fgStatus = FALSE;
	uint32_t au4List[] = {
...
static void usb_mt6653_dumpWfVdnrTimeoutInfo(struct ADAPTER *ad)
{
...
static void usb_mt6653_dumpAhbApbTimeoutInfo(struct ADAPTER *ad)
{
	uint32_t u4RdAddr, u4WrAddr, u4Val = 0, u4WrVal = 0;
	uint32_t u4Idx;
	u_int8_t fgStatus = FALSE;
...
static void usb_mt6653_dumpWfsysReg(struct ADAPTER *ad)
{
	/* Section A: Dump wf_top_misc_on monflag */
	usb_mt6653_dumpWfTopMiscOn(ad);

	/* Section B: Dump wf_top_misc_von monflag */
	usb_mt6653_dumpWfTopMiscVon(ad);

	/* Section A: Dump VDNR timeout host side info */
	usb_mt6653_dumpHostVdnrTimeoutInfo(ad);

	if (!usb_mt6653_ConninfraAp2WfRdableChk(ad))
		return;

	/* Section C: Dump wf_top_cfg_on debug CR */
	usb_mt6653_dumpWfTopCfgon(ad);

	/* Section B: Dump VDNR timeout wf side info */
	usb_mt6653_dumpWfVdnrTimeoutInfo(ad);

	/* Section C: Dump AHB APB timeout info */
	usb_mt6653_dumpAhbApbTimeoutInfo(ad);
}

static void usb_mt6653_dump_sleep_dbg_cr(struct ADAPTER *ad)
{
...
static u_int8_t mt6653_ConninfraOnRdableChk(struct ADAPTER *ad)
{
	uint32_t u4RdAddr, u4Val = 0;
...
static u_int8_t mt6653_ConninfraOffRdableChk(struct ADAPTER *ad)
{
#define CONNINFRA_OFF_POLLING_TIME 4
#define CONNINFRA_IP_VER 0x03010001
	uint32_t u4RdAddr = 0, u4Addr, u4Val = 0;
...
static u_int8_t mt6653_ConninfraAp2WfRdableChk(struct ADAPTER *ad)
{
#define WIFI_IP_VER 0x03010001
...
static void mt6653_dumpConninfraPwrDbg(struct ADAPTER *ad)
{
	uint32_t u4Val = 0;
	struct dump_cr_set *dump = NULL;
	uint32_t size = 0;
...
static void mt6653_dumpConninfraBusDbg(struct ADAPTER *ad,
	u_int8_t fgOnDomain)
{
...
static void mt6653_dumpConninfraClkDbg(struct ADAPTER *ad,
	u_int8_t fgOnDomain)
{
	uint32_t u4Val = 0;
	struct dump_cr_set *dump = NULL;
...
static void mt6653_dumpConninfraReg(struct ADAPTER *ad)
{
	uint32_t u4RdAddr, u4Val = 0;

	if (!mt6653_ConninfraOnRdableChk(ad))
		return;
	...
	/* Dump on domain */
	mt6653_dumpConninfraBusDbg(ad, TRUE);
	mt6653_dumpConninfraClkDbg(ad, TRUE);

	if (!mt6653_ConninfraOffRdableChk(ad))
		return;

	/* Dump off domain */
	mt6653_dumpConninfraPwrDbg(ad);
	mt6653_dumpConninfraBusDbg(ad, FALSE);
	mt6653_dumpConninfraClkDbg(ad, FALSE);
}

static void mt6653_dumpWfsysReg(struct ADAPTER *ad)
{
	/* Section A: Dump wf_top_misc_on monflag */
	mt6653_dumpWfTopMiscOn(ad);
	...
	if (!mt6653_ConninfraAp2WfRdableChk(ad))
		return;
...
static void mt6653_dump_sleep_dbg_cr(struct ADAPTER *ad)
{
	uint32_t u4Addr, u4WrAddr, u4RdAddr, u4Val = 0, u4WrVal = 0;
	uint32_t u4Idx;
	uint32_t au4BgfSelList1[] = {
...
#if defined(_HIF_USB)
		usb_mt6653_dump_sleep_dbg_cr(ad);
#elif defined(_HIF_PCIE)
		mt6653_dump_sleep_dbg_cr(ad);
#endif
		break;
	case SLAVENORESP:
		DBGLOG(HAL, ERROR, "Slave no response!\n");
#if defined(_HIF_USB)
		usb_mt6653_dumpConninfraReg(ad);
		usb_mt6653_dumpWfsysReg(ad);
#elif defined(_HIF_PCIE)
		mt6653_dumpConninfraReg(ad);
		mt6653_dumpWfsysReg(ad);
#endif
		break;
	default:
		break;
