...
#define PERF_MON_UPDATE_LONG_INTERVAL (2000)
#define PERF_MON_TP_MAX_THRESHOLD (12)
#define PERF_MON_TP_NAN_LEVEL (11)
#define PERF_MON_STA_ONLY_THRESHOLD (0xff)
