...
enum ENUM_EVENT_ID {
	...
	EVENT_ID_RTT_RESULT = 0x28,         /* 0x28 (Unsolicited) */
	EVENT_ID_RTT_DONE = 0x29,           /* 0x29 (Unsolicited) */
	...
	EVENT_ID_RTT_CAPABILITIES = 0x2d,   /* 0x2d (Query) */
...
enum ENUM_EVENT_OPMODE_CHANGE_REASON {
	...
	EVENT_OPMODE_CHANGE_REASON_TX_ANT_CTRL = 11,
	EVENT_OPMODE_CHANGE_REASON_START_BW_UPDATE    = 19,
	EVENT_OPMODE_CHANGE_REASON_HW_CONSTRIAN_CAP   = 20,
};
