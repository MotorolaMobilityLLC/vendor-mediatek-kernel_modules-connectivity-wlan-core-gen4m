...
#define CONNAC3X_TX_DESC_HIF_VERSION_MASK                BITS(19, 22)
#define CONNAC3X_TX_DESC_HIF_VERSION_OFFSET              19
...
#define CONNAC3X_TX_DESC_BEAMFORM_TYPE_MASK              BITS(6, 8)
#else
...
#if (CFG_CONNAC3X_DS_VER >= 3500)
#define CONNAC3X_TX_DESC_OM_MAP                          BIT(9)
#else
...
#if (CFG_CONNAC3X_DS_VER >= 3400)
#define CONNAC3X_TX_DESC_OCCUPIED_BY_OTHER_LINK          BIT(11)
#endif
...
/* DW 6 */
#if (CFG_CONNAC3X_DS_VER >= 3500)
#define CONNAC3X_TX_DESC_MULTI_LINK_DEVICE               BIT(0)
#endif
...
#if (CFG_CONNAC3X_DS_VER >= 3600)
#define CONNAC3X_TX_DESC_ENABLE_ICI                      BIT(12)
#endif
#if (CFG_CONNAC3X_DS_VER >= 3500)
#define CONNAC3X_TX_DESC_FORCE_RTS_CTS                   BIT(13)
#define CONNAC3X_TX_DESC_IMMEDIATE_TX                    BIT(14)
#endif
...
#define HAL_MAC_CONNAC3X_TXD_GET_HIF_VERSION(_prHwMacTxDesc) \
TX_DESC_GET_FIELD((_prHwMacTxDesc)->u4DW0, \
CONNAC3X_TX_DESC_HIF_VERSION_MASK, \
CONNAC3X_TX_DESC_HIF_VERSION_OFFSET)

#define HAL_MAC_CONNAC3X_TXD_SET_HIF_VERSION(_prHwMacTxD, _ucVersion)\
...
#define HAL_MAC_CONNAC3X_TXD_SET_QUEUE_INDEX(_prHwMacTxDesc, _ucQueueIndex) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->u4DW0), \
		((uint32_t)_ucQueueIndex), CONNAC3X_TX_DESC_QUEUE_INDEX_MASK, \
...
(((_prHwMacTxDesc)->u4DW7 & CONNAC3X_TX_DESC_FORCE_RTS_CTS)?TRUE:FALSE)
#define HAL_MAC_CONNAC3X_TXD_SET_FORCE_RTS_CTS(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 |= CONNAC3X_TX_DESC_FORCE_RTS_CTS)
...
#define HAL_MAC_CONNAC3X_TXD_SET_SEQUENCE_NUMBER(_prHwMacTxDesc, _u2SN) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->u4DW3), \
		((uint32_t)_u2SN), CONNAC3X_TX_DESC_SEQUENCE_NUMBER_MASK, \
		CONNAC3X_TX_DESC_SEQUENCE_NUMBER_MASK_OFFSET)
...
#if (CFG_CONNAC3X_DS_VER >= 3400)
#define HAL_MAC_CONNAC3X_TXD_IS_OCCUPIED_BY_OTHER_LINK(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u2DW5_0 & CONNAC3X_TX_DESC_OCCUPIED_BY_OTHER_LINK) ? \
TRUE:FALSE)
#define HAL_MAC_CONNAC3X_TXD_SET_OCCUPIED_BY_OTHER_LINK(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u2DW5_0 |= CONNAC3X_TX_DESC_OCCUPIED_BY_OTHER_LINK)
#define HAL_MAC_CONNAC3X_TXD_UNSET_OCCUPIED_BY_OTHER_LINK(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u2DW5_0 &= ~CONNAC3X_TX_DESC_OCCUPIED_BY_OTHER_LINK)
#endif
...
/* DW 6 */
#if (CFG_CONNAC3X_DS_VER >= 3500)
#define HAL_MAC_CONNAC3X_TXD_IS_MLD(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u2DW6_0 & CONNAC3X_TX_DESC_MULTI_LINK_DEVICE)?TRUE:FALSE)
#define HAL_MAC_CONNAC3X_TXD_SET_MLD(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u2DW6_0 |= CONNAC3X_TX_DESC_MULTI_LINK_DEVICE)
#define HAL_MAC_CONNAC3X_TXD_UNSET_MLD(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u2DW6_0 &= ~CONNAC3X_TX_DESC_MULTI_LINK_DEVICE)
#endif
...
#if (CFG_CONNAC3X_DS_VER >= 3600)
#define HAL_MAC_CONNAC3X_TXD_IS_ENABLE_ICI(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u4DW7 & CONNAC3X_TX_DESC_ENABLE_ICI) \
? FALSE : TRUE)
#define HAL_MAC_CONNAC3X_TXD_SET_ENABLE_ICI(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 |= CONNAC3X_TX_DESC_ENABLE_ICI)
#define HAL_MAC_CONNAC3X_TXD_UNSET_ENABLE_ICI(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 &= ~CONNAC3X_TX_DESC_ENABLE_ICI)

#define HAL_MAC_CONNAC3X_TXD_IS_IMMEDIATE_TX(_prHwMacTxDesc) \
(((_prHwMacTxDesc)->u4DW7 & CONNAC3X_TX_DESC_IMMEDIATE_TX) \
? FALSE : TRUE)
#define HAL_MAC_CONNAC3X_TXD_SET_IMMEDIATE_TX(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 |= CONNAC3X_TX_DESC_IMMEDIATE_TX)
#define HAL_MAC_CONNAC3X_TXD_UNSET_IMMEDIATE_TX(_prHwMacTxDesc) \
((_prHwMacTxDesc)->u4DW7 &= ~CONNAC3X_TX_DESC_IMMEDIATE_TX)
#endif
