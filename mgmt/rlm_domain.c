...
static const uint16_t g_u2CountryGroup0[] = {
	...
	/* IKSWU-180648 remove Romania from Worldwide country group */
...
static const uint16_t g_u2CountryGroup18[] = {
	...
	/* IKSWU-180648 add Romania to EU country group */
	COUNTRY_CODE_PT, COUNTRY_CODE_RO, COUNTRY_CODE_SE, COUNTRY_CODE_SI,
...
struct DOMAIN_INFO_ENTRY arSupportedRegDomains[] = {
	...
	,
	{
		...
		NULL, 0,
		{
			...
			{121, BAND_5G, CHNL_SPAN_20, 100, 12, TRUE}
			,			/* CH_SET_UNII_WW_100_144 */
			{125, BAND_5G, CHNL_SPAN_20, 149, 8, TRUE}
						/* CH_SET_UNII_UPPER_149_177 */
			// End IKSWS-77084
#if (CFG_SUPPORT_WIFI_6G == 1)
			,
...
)
{
	...
	if (u1CountryIdx >= COUNTRY_PWR_MODE_6G_SUPPORT_TABLE_SIZE) {
		...
		if (fgDefaultExist) {
			...
			*pfgSupport = g_rCountryPwrMode6GSupport[u1DefaultIdx].
				rSubBand[u16GSubBandIdx].
				fgPwrMode6GSupport[e6GPwrMode];
		} else {
			DBGLOG(RLM, TRACE,
