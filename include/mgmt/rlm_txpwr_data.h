...
struct COUNTRY_POWER_LIMIT_TABLE_CONFIGURATION
	...
	,
	{	{'U', 'S'}
		, 1, {48, 48, 48, 48, 48, 48, 60, 60, 60, 60, 60, 60}
	}
	,
	{	{'U', 'S'}
	...
	,
	{	{'U', 'S'}
		, 11, {48, 48, 48, 48, 48, 48, 60, 60, 60, 60, 60, 60}
	}
	,
	{	{'U', 'S'}
		, 3, {60, 60, 60, 60, 60, 60, 48, 48, 60, 60, 60, 60}
	}
	,
	{	{'U', 'S'}
		, 9, {60, 60, 60, 60, 60, 60, 48, 48, 60, 60, 60, 60}
	}
	,
	{	{'U', 'S'}
	...
	,
	{	{'U', 'S'}
		, 100, {48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48}
	}
	,
	{	{'U', 'S'}
	...
	,
	{	{'U', 'S'}
		, 148, {48, 48, 48, 48, 48, 48, 41, 41, 48, 48, 48, 48}
	}
	,
	{	{'U', 'S'}
		, 151, {60, 60, 60, 60, 60, 60, 48, 48, 60, 60, 60, 60}
	}
	,
	{	{'U', 'S'}
	...
	,
	{	{'U', 'S'}
		, 155, {60, 60, 60, 60, 60, 60, 60, 60, 48, 48, 60, 60}
	}
	,
	{	{'U', 'S'}
...
struct COUNTRY_POWER_LIMIT_TABLE_CONFIGURATION
	...
	,
	{	{'U', 'S'}
		, 11, {48, 48, 48, 60, 60, 60, 60, 60, 60}
	}
	,
	{	{'U', 'S'}
		, 3, {60, 60, 60, 48, 48, 60, 60, 60, 60}
	}
	,
	{	{'U', 'S'}
		, 9, {60, 60, 60, 48, 48, 60, 60, 60, 60}
	}
	,
	{	{'U', 'S'}
	...
	,
	{	{'U', 'S'}
		, 148, {48, 48, 48, 41, 41, 48, 48, 48, 48}
	}
	,
	{	{'U', 'S'}
		, 151, {60, 60, 60, 48, 48, 60, 60, 60, 60}
	}
	,
	{	{'U', 'S'}
	...
	,
	{	{'U', 'S'}
		, 155, {60, 60, 60, 60, 60, 48, 48, 60, 60}
	}
	,
	{	{'U', 'S'}
