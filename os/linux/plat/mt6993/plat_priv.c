...
static int32_t mt6993_wlan_pinctrl_init(struct mt66xx_chip_info *chip_info);
static int32_t mt6993_wlan_pinctrl_action(struct mt66xx_chip_info *chip_info,
	enum WLAN_PINCTRL_MSG msg);

static struct WLAN_PINCTRL_OPS mt6993_pinctrl_ops = {
	.init = mt6993_wlan_pinctrl_init,
	.action = mt6993_wlan_pinctrl_action,
};
#endif
...
int32_t kalPlatOpsInit(void)
{
	...
	chip->pinctrl_ops = &mt6993_pinctrl_ops;
#endif
